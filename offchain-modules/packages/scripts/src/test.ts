...
async function main() {
  ...
  // // const tx = await ckbRpc.getTransaction('0x3e41080968db4f2b4db5d546ffb886a2e46a4444c57b0653563482de84d6da59');
  // const tx = await ckbRpc.getLiveCell({txHash: '0x3e41080968db4f2b4db5d546ffb886a2e46a4444c57b0653563482de84d6da59', index: '0x0'}, false);
